...
class BM {
  ...
  static Color severityColor(String s) {
    switch (s) {
      case 'severe': case 'riesgo': return error;
...
class AppTheme {
  static ThemeData get light {
    ...
    return base.copyWith(
      colorScheme: ColorScheme.fromSeed(seedColor: BM.primary, brightness: Brightness.light),
      scaffoldBackgroundColor: const Color(0xFFF0F0F8),
      cardColor: Colors.white,
      appBarTheme: AppBarTheme(
        backgroundColor: const Color(0xFFF0F0F8), elevation: 0, scrolledUnderElevation: 0,
        centerTitle: false,
      ...
      switchTheme: SwitchThemeData(
        thumbColor: WidgetStatePropertyAll(BM.primary),
        trackColor: WidgetStateProperty.resolveWith((s) =>
            s.contains(WidgetState.selected) ? BM.primary.withOpacity(0.3) : Colors.grey[300]!),
      ),
    );
  }
